...
4. A short, persisted onboarding flow collects display and workspace names.
...
| Onboarding and account profile | Persist a display name, workspace name, and onboarding completion state. | This migration |
...
- Onboarding completion, display name, and workspace name survive refresh and a new browser session.
